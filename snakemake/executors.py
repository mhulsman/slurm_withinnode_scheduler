...
class GenericClusterExecutor(ClusterExecutor):
    ...
    def run(self, job,
        ...
        try:
            ...
            ext_jobid = [xsb.run([jobscript], mem=cwildcards['mem'], runtime=cwildcards['time'], cpus=cwildcards['n'])]
        ...
        if ext_jobid and ext_jobid[0]:
            ...
            logger.info("Submitted job {} with xslurm jobid '{}'.".format(
                jobid, ext_jobid))
